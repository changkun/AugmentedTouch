 ...
 *
 *  @param layerConfig <#layerConfig description#>
 *  @param weights     <#weights description#>
 *  @param outputMode  <#outputMode description#>
 *
 *  @return model self
 */
 ...
 *  @param prediction <#prediction description#>
 */
- (void)predictByFeatureVector:(NSData *)vector intoPredictionVector:(NSMutableData *)prediction;

/**
 *  Predicts multiple new examples by feature-matrix and copies the predictions into specified prediction matrix. The predictions buffer should be allocated to work with double precision.
 *
